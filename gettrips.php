    ...
    if(mysqli_num_rows($result)>0){
        while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
            ...
            <div class='row trip'>
                ...
                <div class='col-sm-2'>
                    <button class='btn btn-info' data-toggle='modal' data-target='#edittripModal' data-trip_id='$trip_id'>Edit</button>
                </div>
        ...
        echo "<div class='alert alert-warning'>You have no trips.</div>";
    }
}
