...
$missingInfo = '<p><strong>Please share a few more words about yourself</strong></p>';
...
if(empty($_POST["moreinformation"])){
    ...
    $moreinformation = filter_var($_POST["noreinformation"], FILTER_SANITIZE_STRING);
}
...
//echo "Please click on the link to activate your account:\n\n";
$message .= "http://tanyalr.host20.uk/CarShare/activate.php?email=".urlencode($email)."&key=$activationKey";
 if (mail($email, 'Confirm your Registration', $message, 'From:'.'admin@tanyalr.host20.uk')) {
...
//echo "<a href='http://tanyalr.host20.uk/CarShare/activate.php?email=".urlencode($email)."&key=$activationKey'>$message</a>";
